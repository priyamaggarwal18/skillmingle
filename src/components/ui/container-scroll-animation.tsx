...
export const Header = ({ translate, titleComponent }: any) => {
  return (
    <motion.div
      ...
      className="max-w-6xl  mx-auto text-center font-bold text-2xl md:text-4xl lg:text-8xl pb-6 md:pb-8 lg:pb-12"
    >
      <span className="mx-auto text-center font-bold text-2xl md:text-6xl lg:text-8xl">Empowering Ideas Through </span>
      {titleComponent}
    </motion.div>
  );
};
