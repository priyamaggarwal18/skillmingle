...
export default function AuthPage() {
    ...
    return (
        <div className="min-h-screen bg-dark-purple-gradient bg-violet-500 flex items-center justify-center p-4">
            ...
            >
                <Card className="border shadow-2xl w-full max-w-xs">
                    {' '}
                    {/* Reduced the width here */}
                    <CardHeader className="space-y-1 bg-gradient-to-r  text-white rounded-t-lg">
                        ...
                        >
                            ...
                            <CardTitle className="text-4xl font-bold text-violet-500">
                                SkillMingle
                            </CardTitle>
                        </motion.div>
                        ...
                        >
                            <TabsList className="flex w-full items-center mb-6">
                                <TabsTrigger
                                    ...
                                    className={
                                        activeTab === 'signin'
                                            ? 'bg-violet-500 px-6 py-2 text-lg'
                                            : ''
                                    }
                                >
                                    Sign In
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Button
                                            className="w-full bg-violet-500 text-white transition-all duration-300"
                                            type="submit"
                                        >
                                            Sign In
                                            ...
                                            >
                                                ...
                                                <SelectContent className="bg-black w-full">
                                                    <SelectItem
                                                        ...
                                                        className="hover:bg-violet-500 w-full"
                                                    >
                                                        project-manager
                                                    </SelectItem>
                                                    <SelectItem
                    ...
                    <CardFooter className="bg-gray-50 rounded-b-lg">
                        <p className="text-center text-gray-600 w-full text-sm">
